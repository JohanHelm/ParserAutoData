...
from domain.models.scenarios import RestylingScenarioData
from .params import DvornikiNormParams, DromNormParams, DromMergedMarketsParams


class ExcelWriter:
    def __init__(self, fullfilepath: Path,
                 excel_params: [DromNormParams, DromMergedMarketsParams, DvornikiNormParams]) -> None:
    ...
    # def write_drom_merged_markets_data(self, computed_generation: ComputedDromData1):
    ...
    def write_data_row(self, some_data: [DvaDvornikaDataNorm, DromGenerationEntity, RestylingScenarioData]):
